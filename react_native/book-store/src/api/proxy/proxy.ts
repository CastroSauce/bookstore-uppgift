...
export * as Client from './proxy/Client';

export * as Query from './proxy/Query';
...
import { addResultTypeFactory } from './proxy/helpers';
export { setBaseUrl, getBaseUrl } from './proxy/helpers';
export { setAxiosFactory, getAxios } from './proxy/helpers';


//-----PersistorHydrator.File-----
import type { PersistedClient } from '@tanstack/react-query-persist-client';
import type { DehydratedState, QueryKey } from '@tanstack/react-query'
import { getResultTypeFactory } from './proxy/helpers';
...
export function initPersister() {
  {/* 
// @ts-ignore */}
  addResultTypeFactory('Client___bookAll', (data: any) => { const result = new BookDto(); result.init(data); return result; });
